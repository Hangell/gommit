...
- ✅ Стандартные типы Conventional Commits: **feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert**  
  Плюс дополнительные: **WIP, prune, security, deps, i18n, typo, breaking**
...
| `--type` | Тип коммита (feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert, WIP, prune, security, deps, i18n, typo, breaking) |
...
| `revert` | ◀️ | Откат к коммиту |
| `security` | 🔒 | Исправление проблем безопасности |
| `deps` | ⬆️ | Обновление или понижение версий зависимостей |
| `i18n` | 🌐 | Интернационализация и локализация |
| `typo` | ✏️ | Исправление опечаток |
| `breaking` | 💥 | Изменения, нарушающие совместимость |
