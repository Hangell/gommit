...
- ✅ स्टैंडर्ड Conventional Commits प्रकार: **feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert**  
  अतिरिक्त: **WIP, prune, security, deps, i18n, typo, breaking**
...
| `--type` | टाइप (feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert, WIP, prune, security, deps, i18n, typo, breaking) |
...
| `revert` | ◀️ | किसी कमिट पर वापस जाना |
| `security` | 🔒 | सुरक्षा समस्याएँ ठीक करना |
| `deps` | ⬆️ | निर्भरताएँ अपग्रेड या डाउनग्रेड करना |
| `i18n` | 🌐 | अंतर्राष्ट्रीयकरण और स्थानीयकरण |
| `typo` | ✏️ | टाइपिंग की गलतियाँ ठीक करना |
| `breaking` | 💥 | संगतता तोड़ने वाले बदलाव |
